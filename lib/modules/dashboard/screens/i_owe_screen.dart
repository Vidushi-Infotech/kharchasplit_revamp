...
/// Screen showing all groups where user owes money
class IOweScreen extends ConsumerWidget {
  const IOweScreen({Key? key}) : super(key: key);
  ...
  Widget _buildGroupRow(BuildContext context, bool isDark, dynamic group) {
    final owedAmount = group.myBalance.abs();

    return Semantics(
      button: true,
      label:
          'Group ${group.name} - you owe ₹${owedAmount.toStringAsFixed(2)}',
